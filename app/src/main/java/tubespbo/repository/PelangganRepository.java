...
import tubespbo.domain.Membership;
...
public class PelangganRepository {
    ...
    private Pelanggan mapResultSetToPelanggan(ResultSet resultSet) throws SQLException {
        ...
        // Nilai tambahan dari database diset setelah object dasar Pelanggan dibuat
        pelanggan.setJumlahTransaksi(resultSet.getInt("jumlah_transaksi"));
        pelanggan.setLevelMembership(Membership.valueOf(resultSet.getString("level_membership")));
        return pelanggan;
    }
